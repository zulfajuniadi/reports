    ...
    <div class="filter-wrapper" ng-cloak>
        ...
        <div class="table-wrapper">
            <table class="table table-bordered table-sm table-striped table-hover">
                ...
                <tbody>
                    <tr ng-repeat="row in data" class="{{row.class}}">
                        <td ng-if="!column.colspan" ng-repeat="column in row.columns" class="{{column.class}}">{{column.content}}</td>
                        <td ng-if="column.colspan" colspan="{{column.colspan}}" ng-repeat="column in row.columns" class="{{column.class}}">{{column.content}}</td>
                    </tr>
                </tbody>
            </table>
        </div>
